...
import io.github.redrain0o0.bedrock.client.gui.components.json.JsonUIButton;
...
public class JsonUIConfirmExitScreen extends Screen {
    ...
    public JsonUIConfirmExitScreen(Screen screen, Component component) {
        super(component);
    ...
    protected void init() {
        ...
        this.addRenderableWidget(JsonUIButton.builder(Component.translatable("gui.ok").withStyle(Style.EMPTY.withShadowColor(0)), (button) -> {
            this.minecraft.stop();
        }).bounds(this.width / 2 - 100, this.height / 2 + 17, 200, 31).build());
        this.addRenderableWidget(JsonUIButton.builder(Component.translatable("gui.cancel").withStyle(Style.EMPTY.withShadowColor(0)), (button) -> {
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        guiGraphics.drawString(this.font, Component.translatable("bedrock.menu.exitMinecraft").withStyle(Style.EMPTY.withShadowColor(0)), this.width / 2 - 95, this.height / 2 - 60, 16777215);
